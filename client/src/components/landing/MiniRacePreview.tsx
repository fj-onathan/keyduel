...
export function MiniRacePreview({ raceData, settledWinnerState }: { raceData: RacePreviewData; settledWinnerState: boolean }) {
  ...
  return (
    <div key={raceData.round} className={settledWinnerState ? 'mini-race mini-race-enter is-finish' : 'mini-race mini-race-enter'}>
      <div className={settledWinnerState ? 'mini-race-lane is-eliminated' : 'mini-race-lane'}>
        <div className="mini-race-meta">
          ...
          <em>
            {raceData.wpm.alpha} WPM <i className={raceData.lead === 'alpha' ? 'lane-status lane-status-alpha is-lead' : 'lane-status lane-status-alpha'}>lead</i>
          </em>
        </div>
      ...
      <div className={settledWinnerState ? 'mini-race-lane is-eliminated' : 'mini-race-lane'}>
        <div className="mini-race-meta">
          ...
          <em>
            {raceData.wpm.beta} WPM <i className={raceData.lead === 'beta' ? 'lane-status lane-status-beta is-lead' : 'lane-status lane-status-beta'}>lead</i>
          </em>
        </div>
        <div className="mini-race-track">
      ...
      <div className={settledWinnerState ? 'mini-race-lane is-winner' : 'mini-race-lane'}>
        <div className="mini-race-meta">
          ...
          <em>
            {raceData.wpm.gamma} WPM <i className={raceData.lead === 'gamma' ? 'lane-status lane-status-gamma is-lead' : 'lane-status lane-status-gamma'}>lead</i>
          </em>
        </div>
        <div className="mini-race-track">
      ...
      <div className={settledWinnerState ? 'mini-race-winner-banner is-visible' : 'mini-race-winner-banner'}>Winner</div>
    </div>
  )
}
