...
export function ProfileKeyDuelSummary({summary}: Props) {
  return (
    <article className="profile-panel profile-main-card self-start">
      ...
      >
        <p
          className="m-0 text-xs sm:text-sm text-[#e7d2bc] border border-white/[0.08] rounded-lg bg-[rgba(25,14,11,0.62)] py-1.5 px-2 sm:py-2 sm:px-2.5">
        ...
        <p
          className="m-0 text-xs sm:text-sm text-[#e7d2bc] border border-white/[0.08] rounded-lg bg-[rgba(25,14,11,0.62)] py-1.5 px-2 sm:py-2 sm:px-2.5 sm:col-span-2">
